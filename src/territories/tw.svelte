...
>
	<defs
		><pattern id="tw" patternUnits="userSpaceOnUse" width="100%" height="100%">
			{#key showFlag}
				<svg
					{preserveAspectRatio}
					...
					/><circle cy="150" cx="225" r="60" fill="#fff" stroke="#000095" stroke-width="7.5" /></svg
				>
			{/key}
		</pattern></defs
	><path
