...
>
	<defs
		><pattern id="bb" patternUnits="userSpaceOnUse" width="100%" height="100%">
			{#key showFlag}
				<svg
					{preserveAspectRatio}
					...
					/><use xlink:href="#a" transform="matrix(-1 0 0 1 24000 0)" /></svg
				>
			{/key}
		</pattern></defs
	><path
