...
>
	<defs
		><pattern id="rw" patternUnits="userSpaceOnUse" width="100%" height="100%">
			{#key showFlag}
				<svg
					{preserveAspectRatio}
					...
					><path fill="#20603D" d="M0 0h1080v720H0z" /><path
						fill="#FAD201"
						d="M0 0h1080v540H0z"
					/><path fill="#00A1DE" d="M0 0h1080v360H0z" /><g transform="translate(886.5 188.1)"
						><g id="b"
							><path
								id="a"
								fill="#E5BE01"
						...
						><use xlink:href="#b" transform="scale(-1 1)" /><circle
							r="34.3"
							fill="#E5BE01"
							stroke="#00A1DE"
							stroke-width="3.4"
