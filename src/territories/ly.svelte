...
>
	<defs
		><pattern id="ly" patternUnits="userSpaceOnUse" width="100%" height="100%">
			{#key showFlag}
				<svg
					{preserveAspectRatio}
					...
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 960 480"
					><path fill="#239e46" d="M0 0h960v480H0z" /><path d="M0 0h960v360H0z" /><path
						fill="#e70013"
						d="M0 0h960v120H0z"
					/><circle cx="480" cy="240" r="60" fill="#fff" /><circle
						cx="492.132"
						cy="240"
						r="52.132"
					/><path
