...
>
	<defs
		><pattern id="eh" patternUnits="userSpaceOnUse" width="100%" height="100%">
			{#key showFlag}
				<svg
					{preserveAspectRatio}
					...
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 600 300"
					><path d="M0 0h600v150H0z" /><path fill="#007a3d" d="M0 150h600v150H0z" /><path
						fill="#fff"
						d="M0 100h600v100H0z"
					/><path d="m0 0 200 150L0 300z" fill="#c4111b" /><circle
						cx="300"
						cy="150"
						r="40"
						fill="#c4111b"
					/><circle cx="315" cy="150" r="40" fill="#fff" /><path
