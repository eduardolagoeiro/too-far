...
>
	<defs
		><pattern id="ke" patternUnits="userSpaceOnUse" width="100%" height="100%">
			{#key showFlag}
				<svg
					{preserveAspectRatio}
					...
					><defs
						><path
							...
							transform="rotate(30)"
						/></defs
					><path fill="#fff" d="M-120-80h240V80h-240z" /><path d="M-120-80h240v48h-240z" /><path
						fill="#060"
						d="M-120 32h240v48h-240z"
					/><g id="b"><use xlink:href="#a" stroke="#000" /><use xlink:href="#a" fill="#fff" /></g
					><use xlink:href="#b" transform="scale(-1 1)" /><path
						fill="#b00"
						d="M-120-24v48h101c3 8 13 24 19 24s16-16 19-24h101v-48H19C16-32 6-48 0-48s-16 16-19 24z"
					/><path id="c" d="M19 24c3-8 5-16 5-24s-2-16-5-24c-3 8-5 16-5 24s2 16 5 24" /><use
						xlink:href="#c"
						transform="scale(-1 1)"
					/><g fill="#fff"
						><ellipse rx="4" ry="6" /><path id="d" d="M1 5.85s4 8 4 21-4 21-4 21z" /><use
							xlink:href="#d"
							transform="scale(-1)"
