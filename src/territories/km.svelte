...
>
	<defs
		><pattern id="km" patternUnits="userSpaceOnUse" width="100%" height="100%">
			{#key showFlag}
				<svg
					{preserveAspectRatio}
					...
					><path fill="#3A75C4" d="M0 0h500v300H0z" /><path
						fill="#CE1126"
						d="M0 0h500v225H0z"
					/><path fill="#FFF" d="M0 0h500v150H0z" /><path fill="#FFC61E" d="M0 0h500v75H0z" /><path
						fill="#3D8E33"
						d="m0 300 250-150L0 0v300z"
					/><circle fill="#FFF" cx="85" cy="150" r="67.5" /><circle
						fill="#3D8E33"
						cx="115"
						cy="150"
						r="67.5"
					...
					/><use xlink:href="#a" y="32.208" /><use xlink:href="#a" y="64.417" /><use
						xlink:href="#a"
						y="96.625"
					/></svg
				>
