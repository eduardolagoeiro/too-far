...
>
	<defs
		><pattern id="jo" patternUnits="userSpaceOnUse" width="100%" height="100%">
			{#key showFlag}
				<svg
					{preserveAspectRatio}
					...
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 840 420"
					><path fill="#007a3d" d="M0 0h840v420H0z" /><path fill="#fff" d="M0 0h840v280H0z" /><path
						d="M0 0h840v140H0z"
					/><path d="M0 0v420l420-210z" fill="#ce1126" /><path
