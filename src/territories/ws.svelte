...
>
	<defs
		><pattern id="ws" patternUnits="userSpaceOnUse" width="100%" height="100%">
			{#key showFlag}
				<svg
					{preserveAspectRatio}
					...
					><defs><path id="a" d="m0 0 .309.951L-.5.363h1l-.809.588z" /></defs><path
						fill="#ce1126"
						d="M0 0h2880v1440H0z"
