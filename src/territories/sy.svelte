...
>
	<defs
		><pattern id="sy" patternUnits="userSpaceOnUse" width="100%" height="100%">
			{#key showFlag}
				<svg
					{preserveAspectRatio}
					...
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 900 600"
					><path d="M0 0h900v600H0z" /><path d="M0 0h900v400H0z" fill="#fff" /><path
						d="M0 0h900v200H0z"
						fill="#ce1126"
					/><path
