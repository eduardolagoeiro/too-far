...
>
	<defs
		><pattern id="lt" patternUnits="userSpaceOnUse" width="100%" height="100%">
			{#key showFlag}
				<svg
					{preserveAspectRatio}
					...
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 5 3"
					><path fill="#BE3A34" d="M0 0h5v3H0z" /><path fill="#046A38" d="M0 0h5v2H0z" /><path
						fill="#FFB81C"
						d="M0 0h5v1H0z"
					/></svg
				>
